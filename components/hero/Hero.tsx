    ...
    <section className="min-h-screen bg-black text-white flex items-center pt-32">
      <div className="max-w-6xl mx-auto px-8 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <button className="bg-orange-500 text-white px-8 py-4 rounded-full font-semibold shadow-lg hover:bg-orange-600 hover:shadow-orange-500/30 hover:scale-105 transition-all duration-300">
             Book Assessment →
          </button>
